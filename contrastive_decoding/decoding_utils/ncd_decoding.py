...
import transformers
from transformers.generation.utils import SampleOutput, GreedySearchOutput

def evolve_ncd_sampling():
...
def sample(
    ...
    **model_kwargs,
    ...
    while True:
        ...
        use_cd = model_kwargs.get("input_ids_ncd") != None
        ...
        input_ids_ncd = torch.cat([input_ids_ncd, next_tokens_cd[:, None]], dim=-1)
        ...
        if use_cd:
            ...
            model_kwargs_cd["input_ids_ncd"] = input_ids_ncd
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if use_cd:
                ...
                next_token_scores_cd = logits_processor(input_ids_ncd, next_token_logits_cd)
                next_tokens_cd = torch.argmax(next_token_scores_cd, dim=-1)
