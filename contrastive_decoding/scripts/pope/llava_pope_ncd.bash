...
if [[ $neg == false ]]; then
    ...
    neg_question_file=./data/POPE/${dataset_name}/${dataset_name}_pope_${type}_neg${ver}.json
    experiment=${model_name}-${dataset_name}-${type}-ncd-t${temperature}-a${cd_alpha}-b${cd_beta}-seed${seed}-neg${ver}-full
else
    neg_question_file=./data/POPE/${dataset_name}/${dataset_name}_pope_${type}.json
    question_file=./data/POPE/${dataset_name}/${dataset_name}_pope_${type}_neg${ver}.json
    experiment=NEG${ver}-${model_name}-${dataset_name}-${type}-ncd-t${temperature}-a${cd_alpha}-b${cd_beta}-seed${seed}-neg${ver}-full
fi
