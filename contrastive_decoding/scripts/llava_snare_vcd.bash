...
if [[ ${subclausal} == false ]]; then
    experiment=${model_name}-vcd-t${temperature}-a${cd_alpha}-b${cd_beta}-seed${seed}_v1.5
else
    experiment=subclausal-${model_name}-vcd-t${temperature}-a${cd_alpha}-b${cd_beta}-seed${seed}_v1.5
fi
